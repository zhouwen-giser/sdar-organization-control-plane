...
export const ROUTE_DEFINITIONS: RouteDefinition[] = [
  ...
  { id: 'telemetry', pattern: '/telemetry-export', title: 'Telemetry Export', section: 'Runtime' },
  { id: 'telemetry-edit', pattern: '/telemetry-export/edit', title: '编辑 Telemetry Export Revision', section: 'Runtime' },
